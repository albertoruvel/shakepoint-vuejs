    ...
    <header class="navbar-fixed-top header" role="banner">
            <div class="container header-container">
                ...
                <nav v-if="securityRole !== 'ANONYMOUS'" class="collapse" id="main-menu">
                    ...
                    <ul v-if="securityRole == 'PARTNER'">
                        <li>
                            <router-link to="/partner/trainers">Entrenadores</router-link>
                        </li>
                        <li>
                            <router-link to="/partner/vendings">Vendings</router-link>
                        </li>
                    </ul>
                </nav>
            </div>
...
<style lang="scss" scoped>
    ...
    @media(min-width: 768px) {
        ...
        #main-menu>ul>li>a:hover {
            color: $accent; //border-bottom: 4px solid $accent;
        }
        .menu-button {
            display: none;
        }
